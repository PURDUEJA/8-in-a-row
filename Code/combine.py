...
# Note: Everything has been compiled so don't need to work on any other functions.
# Everything needed is in playerGameLoop() at the bottom of the file.
# Don't need to look at anything above line 228.
# Everything with triple apostrophe is important
